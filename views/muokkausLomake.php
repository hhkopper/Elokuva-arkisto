...
<html>
	...
	<body>
		...
		<form action="tallennaMuutokset.php" method="post">
			...
			Näyttelijä: <input type ="text" value="<?php if (isset($data->nayttelijat[0])) echo $data->nayttelijat[0]; ?>" name="nayttelija1"><br>
				<input type ="text" value="<?php if (isset($data->nayttelijat[1])) echo $data->nayttelijat[1]; ?>" name="nayttelija2"><br>
				<input type ="text" value="<?php if (isset($data->nayttelijat[2])) echo $data->nayttelijat[2]; ?>" name="nayttelija3"><br>
				<input type ="text" value="<?php if (isset($data->nayttelijat[3])) echo $data->nayttelijat[3]; ?>" name="nayttelija4"><br>
				<input type ="text" value="<?php if (isset($data->nayttelijat[4])) echo $data->nayttelijat[4]; ?>" name="nayttelija5"><br><br>
